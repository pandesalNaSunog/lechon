...
<div class="mt-5">
    <div class="container">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/admin/inventory/freebie/{{$freebie->id}}">
                                    ...
                                    <form action="/admin/inventory/freebie/{{$freebie->id}}/delete" method="POST" onsubmit="return confirm('Confirm?')">
                                        @csrf
                                        @method('DELETE')
        ...
        <a href="/admin/inventory/add-freebee">
