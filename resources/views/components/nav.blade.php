...
<nav class="navbar navbar-expand-xxl bg-orange navbar-dark sticky-top">
  ...
  <path fill-rule="evenodd" d="M10.5 3.5a2.5 2.5 0 0 0-5 0V4h5v-.5zm1 0V4H15v10a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V4h3.5v-.5a3.5 3.5 0 1 1 7 0zm-.646 5.354a.5.5 0 0 0-.708-.708L7.5 10.793 6.354 9.646a.5.5 0 1 0-.708.708l1.5 1.5a.5.5 0 0 0 .708 0l3-3z"/>
                ...
                <li class="nav-item">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="/lolabertarevamp/profile" class="dropdown-item">Profile</a>
                            </li>
                            <hr class="dropdown-divider">
                            <li>
                                <a href="/lolabertarevamp/logout" class="dropdown-item">Log Out</a>
                            </li>
                        </ul>
                    </div>
                ...
                @else
                <li class="nav-item">
                    <a class="fw-bold nav-link" href="/lolabertarevamp/login">Sign In</a>
                </li>
                <li class="nav-item">
                    <a class="fw-bold nav-link" href="/lolabertarevamp/signup">Sign Up</a>
                </li>
                @endauth
            </ul>
        </div>
